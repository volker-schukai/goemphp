...
/*
// #cgo CFLAGS: -I${SRCDIR}/php-lib/ -I${SRCDIR}/php-lib/main -I${SRCDIR}/php-lib/TSRM -I${SRCDIR}/php-lib/Zend -I${SRCDIR}/php-lib/ext
// #cgo LDFLAGS: -L${SRCDIR}/php-lib/sapi/embed/.libs/ -lphp_embed.o
// #cgo CFLAGS: -g -Wall
// #include <stdlib.h>
// #include <main/php.h>
// FILE *php!!_unset(void) { return stdout; }
*/
import "C"
import _ "unsafe"
